...
from napl.sim.operation import decode, encode, gt_rc
...
def _kernel_specific_checks():
    ...
    for device in devices():
        ...
        error, result = gt_rc_inst.accuracy.analyze(r_value, verbose=True)
...
def test_gt_rc():
    """Verify gt_rc for both polarities against analytic and known-answer streams."""
