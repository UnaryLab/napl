"""Flux-stability profile for the lt_rc streaming operation."""
...
def profile():
    """Return the flux-stability result dicts for lt_rc, one per supported polarity."""
    return [
        profile_op(
            lt_rc,
            ...
            # lt_rc emits a unipolar {0, 1} indicator for input_0 < input_1.
