"""Flux-stability profile for the signabs_interleave streaming operation."""
...
def profile():
    """Return the flux-stability result dicts for signabs_interleave, one per supported polarity."""
