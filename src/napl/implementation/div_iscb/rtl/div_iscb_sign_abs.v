...
//==============================================================================
// div_iscb_sign_abs -- sign/magnitude of a bipolar rate-coded spike (stateful).
//
// RTL counterpart of napl.operation.sign_abs with width=3, as instantiated by
// div_iscb's bipolar_forward (src/napl/operation/sign_abs.py). Internal helper
