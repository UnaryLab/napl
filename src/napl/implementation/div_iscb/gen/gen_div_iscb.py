...
functional Python model (napl.operation.div_iscb) -- so the testbench checks the
...
widths/depths (sync_skewed width 3, div_cordiv depth 2, sign_abs/bi2uni/uni2bi
