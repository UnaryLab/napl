...
//
// RTL counterpart of napl.operation.square_dff with config polarity='unipolar'
// (src/napl/operation/square.py).  Squares a single spike stream by ANDing it
// with a depth-DEPTH delayed copy of itself (a D flip-flop chain), per uGEMM.
//
//   out = i_in & dff(i_in)        (AND)
//
