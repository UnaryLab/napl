...
//==============================================================================
// mul_ugemm_sr_unipolar -- shift-register decorrelated unary multiplication.
//
// This is the scalar RTL counterpart of napl.sim.operation.mul_ugemm_sr with
...
module mul_ugemm_sr_unipolar #(
    ...
    initial $readmemb("vec/mul_ugemm_sr_rom.hex", rng_rom);
    ...
    assign o_out = i_input_0 & threshold_hit;
