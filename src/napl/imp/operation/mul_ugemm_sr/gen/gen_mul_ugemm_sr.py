"""Generate mul_ugemm_sr vectors and its model-derived threshold ROM."""
import sys
...
VEC = ROOT / "vec" / "mul_ugemm_sr.vec"
PARAMS = ROOT / "vec" / "mul_ugemm_sr_params.vh"
ROM = ROOT / "vec" / "mul_ugemm_sr_rom.hex"

# Configuration mirrors test_mul_ugemm_sr.py.
WIDTH = 4
TIMESTEPS = 256
OP_CONFIG = {"width": WIDTH, "generator": "sobol", "dim": 1}


require_seeded_sys(OP_CONFIG)
