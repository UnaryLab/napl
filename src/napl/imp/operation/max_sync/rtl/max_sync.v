...
// Maximum of two rate-coded streams, equivalent to napl.sim.operation.max_sync;
...
// correlation of the two streams, and an OR gate then returns the larger rate.
// The circuit is identical for both polarities, so there is no polarity
// variant.
...
module max_sync #(
    ...
    output wire o_output    // spike stream carrying the larger of the two values
);
