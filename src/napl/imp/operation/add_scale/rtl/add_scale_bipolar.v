...
// Bipolar napl.sim.operation.add_scale with an ENTRY-lane spike input.
...
module add_scale_bipolar #(
    ...
    localparam integer TWO_OFS = ENTRY - SCALE;      // 2*offset = entry - scale
