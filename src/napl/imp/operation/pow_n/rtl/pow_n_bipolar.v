...
// Bipolar x^n: a chain of N-1 Gaines multiplies (XNOR), each combining the
...
// Composes the standalone dff and mul_gaines_bipolar modules (resolved by the -y
// library), matching napl.sim.operation.pow_n's internal wiring.


module pow_n_bipolar #(
