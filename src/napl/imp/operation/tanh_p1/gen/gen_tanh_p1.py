...
VEC = ROOT / "vec" / "tanh_p1.vec"
PARAMS = ROOT / "vec" / "tanh_p1_params.vh"
ROM = ROOT / "vec" / "tanh_p1_rom.hex"
CONFIG = {
    "polarity": "unipolar",
    "timestep": 256,
    "generator": "sobol",
...
def main():
    ...
    print(
        ...
        f"{PARAMS}, and {ROM} ({len(model.coef_bits)} ROM lines)"
    )
