...
// napl.sim.module.conv (unipolar) over LANES output pixel-channels.
...
// KERNEL_W mul_gaines_unipolar cells plus the optional bias spike feeding one
// add_any_unipolar. Those are operation-layer circuits and are instantiated rather
