...
from napl.sim.module._shared import _shift_round_clamp
from napl.utils import pow2_rshift
...
class _round_ste_fn(torch.autograd.Function):
    ...
    def forward(ctx, input, fracwidth, min_val, max_val):
        scaled = _shift_round_clamp(input, -fracwidth, min_val, max_val)
...
def round_ste(input, fracwidth=0, min_val=None, max_val=None):
    ...
    **Example:**
    ...
    .. code-block:: python
        ...
        import torch
        from napl.sim.module import round_ste
