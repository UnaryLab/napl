...
class mgu_hard_mix(napl_base):
    r"""Evaluate a bipolar rate-coded MGU cell one timestep at a time.

    Use this class as a streaming MGU cell directly when input and hidden spike
    streams are already available. The numeric hidden
    ...
    def __init__(self, weight_f, bias_f, weight_n, bias_n, hx_value,
        ...
        def lin(w, b, d):
            return linear_mix(w, b, {'polarity': 'bipolar', 'timestep': ts, 'generator': gen,
